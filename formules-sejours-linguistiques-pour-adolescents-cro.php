                    ...
                    <!-- End Newsletter Box -->
					   ...
					   <?
													...
													<h2> <?=stripslashes($data2["nom"])?></h2><br><br>
															 ...
															 <diV align="right" class="button col-md-4 col-sm-11"><a class="bouton" href="recherche_junior_cro.php?site=etudiant&pays=&ville=&id_date=&formule=<?=$data2["id"]?>"><i class="fa fa-book"></i>&nbsp;Voir la liste des séjours </a></div>
