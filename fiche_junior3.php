...
<?
									...
									while($data_date = mysql_fetch_assoc($exec_date)){
										...
										<!-- 2e case -->
										  <div class="col-md-6 col-xs-6"><? if($data_date["tarif"] != "0"){ ?>
                                         ...
                                         <!-- 3e case -->
										  ...
										  <DIV class="button col-xs-4"><a class="bouton" href="junior_reserver_sejour.php?fiche=<?=$_GET["fiche"]?>&date=<?=$data_date["id"]?>">Réserver ce séjour</a></div>
										 
										  </div>
										   <div class="col-md-6 col-xs-5">
										  <DIV class="button col-xs-4"><a class="bouton" href="devis_junior.php?fiche=<?=$_GET["fiche"]?>&date=<?=$data_date["id"]?>">Mettre une option</a></div>
										  </div>										  
                                          <? } ?>
                    ...
                    <div class="content-carousel">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- Title-->
                                <div class="titles">
                                    <h2>Tous nos séjours <?=$nom_pays?></h2>
                                </div>
                                <!-- End Title-->
                            </div>
                        </div>
                        ...
                        <div id="properties-carousel" class="properties-carousel">
                           <?
									$query = "SELECT fj.*, p.nom as pays, v.nom as ville FROM fiche_junior fj INNER JOIN junior_pays p ON fj.pays = p.id INNER JOIN junior_ville v ON fj.ville = v.id LEFT OUTER JOIN fiche_junior_hebergement fjh ON fj.id = fjh.fiche_junior LEFT OUTER JOIN fiche_junior_formule fjf ON fj.id = fjf.fiche_junior WHERE fj.complet ='0' AND fj.afficher = '1'";
...
?>											 							 
					...
					<!-- fin mise en page large -->
					
					<!-- mise en page tablette -->
                        <div class="col-md-9 hidden-lg hidden-xl">
