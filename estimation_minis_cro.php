...
//$query2 = "SELECT * FROM hebergement_minis WHERE id IN (SELECT rid_hebergement FROM fiche_minis_tarif WHERE rid_zone = '".addslashes($zone)."')";
...
<tr><td colspan="2" align="center" style="font-size:14px"><div style="background:#a79496; margin:auto; color:#FFFFFF; padding:5px; font-size:16px; border-radius:4px; width:30%;">TOTAL : <b><span id="total"><?=$total?></span>€</b></div></td></tr>
<tr><td colspan="2">
<? if ($total =="0")
									{									
																		echo "<br><b>Votre demande nécessite un calcul personnalisé</b>"; 
									} ?>

<br><i>Vous souhaitez recevoir un devis complet pour cette destination ?</i><diV class="button" style="background:#E1483F;  color:#FFFFFF; padding:5px; font-size:16px; width:40%;"><a class="bouton" target="_top" href="votre-devis-scolaire.php?sejour=<?=$data_d["id"]?>">&nbsp;&nbsp;&nbsp;<i class="fa fa-refresh"></i>&nbsp;&nbsp;&nbsp;Demandez un devis personnalisé</a></div></td></tr>
</table>
</form>
