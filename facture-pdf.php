...
class PDF extends FPDF{
	...
	function Footer(){
		...
		$this->SetY(-19);
		$this->Cell(0,10,'British European Centre est une marque de FV CONSULTING – SARL au capital de 100 000 euros - APE 7911Z',0,0,'C');
		$this->SetY(-15);
...
if(isset($_GET["id"])){
	...
	$pdf->SetXY(30, 176);
	$pdf->Write(15, "Pack multirisques : ".(($row["ass_interruption"] == "1") ? "OUI" : "NON"));
	$pdf->SetXY(170, 176);
	$pdf->Write(15, (($row["ass_interruption"] == "1") ? parsePrix(round($row["soustotal"]*0.045, 2)) : 0)." €");
	$pdf->SetXY(30, 182);
