                                    ...
                                    <tr>
                                      ...
                                      <table width="100%" border="0" align="center" cellpadding="3" class="texteGris">
                                        ...
                                        <tr>
                                          ...
                                          <td><select name="date_naiss_j" class="select"><?=sel_date("jour",$date_naiss_j)?></select> <select name="date_naiss_m" class="select"><?=sel_date("mois",$date_naiss_m)?></select> <select name="date_naiss_a" class="select"><?=sel_date("annee",$date_naiss_a,1990)?></select></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tr>
                                      ...
                                      <table width="100%" border="0" align="center" cellpadding="3" class="texteGris">
                                        ...
                                        <td align="left" width="33%" valign="top">
                                            ...
                                            <br />
                                            Le départ étant à moins de 30 jours, le montant total du séjour sera prélevé sur votre CB à l’inscription
                                        </td>
                                        <? }else{ ?>
                                        <td align="left" width="33%" valign="top">
                                        ...
                                        <td align="left" width="33%" valign="top">
                                            ...
                                            <br />
                                            <? if($nb_jour < $limite){ ?>
                                            Vous payez l'acompte immédiatement en CB. Le départ étant à moins de 30 jours, le solde du séjour doit nous parvenir par chèque sous 3 jours ouvrés.
                                            <? }else{ ?>
                                        ...
                                        <td align="left" valign="top">
                                            <table align="center" cellpadding="0" cellspacing="0"><tr><td align="center"><input type="radio" name="paiement" value="7" checked="checked" /></td></tr><tr><td align="center" height="65"><img src="images/logo_cheque.jpg" /></td></tr><tr><td align="center"><b>Tout chèque</b></td></tr></table>
                                            <br />
                                            Le départ étant à moins de 30 jours, le montant total du séjour doit nous parvenir par chèque sous 3 jours ouvrés.
                                        </td>
                                        <? }else{ ?>
                                        <td align="left" valign="top">
