							...
							<div class="info_team">
							 ...
							 <?
							  ...
							  <ul>  
                                 ...
                                 <? } ?>
									<br><br>
                    <diV class="button"><a class="bouton" href="votre-devis-scolaire.php?sejour=<?=$data_d["id"]?>">Votre devis personnalisé</a></div>
					<diV class="button" style="background-color: transparent !important; border: solid 1px #E1483F; line-height: 24px; font-size: 18px;"><a style="color: #E1483F;" href="http://www.becfrance.com/wp/voyages-scolaires-contact/">Contactez un conseiller</a></div>                                          				
									 </div>
                    ...
                    <div class="row padding_top">
                        <div class="col-md-9">
                            ...
                            <ul class="tabs"> 
								...
								<? } ?>
								<li><a href="#tab2"><i class="fa fa-eur"></i> Estimation Tarifaire</a></li>		
                            ...
                            <div class="tab_container"> 
							 ...
							 <!--Tab2 Genral info-->    
								<div id="tab2" class="tab_content">
									...
									<iframe class="embed-responsive-item" src="estimation_minis_cro.php?fiche=<?=$data_d["id"]?>"></iframe>	
										</div>
								  </div>
								</div>						  
