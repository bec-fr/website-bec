...
*/
        ...
        * Properties
        */
        nomformulaire=arguments[4];
        nomzonedate=arguments[5];
...
*/
        function dynCalendar_show()
        {
                ...
                //rajouter pour avoir le bon affichage en français
                firstOfMonth-=1;
                if(firstOfMonth==-1){firstOfMonth=6;}
...
*/
        function dynCalendar_writeHTML()
        {
                if (is_ie5up || is_nav6up || is_gecko) {
                        document.write('<a href="javascript: ' + this.objName + '.show()"><img src="' + this.imagesPath + 'dynCalendar.gif" border="0" width="16" height="16" align="absmiddle" /></a>');
...
*/
        ...
        function calendarCallback(date, month, year)
                {
               //on utilise le nom du formulaire en paramètre
                        ...
                        document.forms[nomformulaire].elements[nomzonedate].value=date;
                }