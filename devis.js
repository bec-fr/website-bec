...
function actualiserDepartements()
{
    ...
    var blocListe = document.getElementById('blocDepartements2');
...
function devis(pays,destination)
{
    ...
    else
    {
        ...
        var url = "devis_adultes.php?pays="+ pays + "&destination="+ destination;
