...
// -------------------------------------------------------------------------------------------------------------------------------
  ...
  $(document).ready(function($) {
    ...
    // Skin value
    var skin = "purple"; // yellow (default), red ,blue,purple,green, orange, purple, pink, cocoa, custom 

    // Boxed value
    var layout = "layout-semiboxed"; // layout-wide (default), layout-boxed, layout-boxed-margin , layout-semiboxed
 ...
 $(".pink").click(function(){
	...
	$(function(){
		...
		if ($.cookie('displayoptions') == "1")
		{
			...
			$('#theme-options').delay(1200).animate({
				left: "-220px"
			},{
				duration: 1500				
			});
