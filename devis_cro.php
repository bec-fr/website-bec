...
<head>        
        ...
        <meta name="description" content="Etablir un devis pour un séjour étudiant - BEC Séjours linguistiques">
                ...
                <div class="container">
                    <div class="row"> 
                        ...
                        <div class="col-md-10"><br>
                            <h1>Demandez un devis personnalisé pour votre séjour linguistique</h1>
                        </div> 
...
if(isset($_POST["ok"]) && $_POST["ok"] == 1){
	...
	$_SESSION["devis_frais_adm"] = $_POST["frais_adm"];
	...
	echo "<script>document.location.href='devis_cro_2.php';</script>";
}else{
...
<br />
                  ...
                  <form class="form-horizontal" action="" method="post" name="form">
                    <input type="hidden" value="0" name="ok" />
					 ...
					 <div class="titles">
                        <h2>&nbsp;Recevez votre devis personnalisé - Etape 1/2</h2>                               
					</div>
					...
					<?
$query = "SELECT id, nom, lib_tarif_1, lib_tarif_2, lib_tarif_3 FROM fiche_etudiant_adulte WHERE id = '".addslashes($_POST["destination"])."'";
$exec = mysql_query($query) or die(mysql_error());
$data = mysql_fetch_assoc($exec);
$col2 = stripslashes($data["lib_tarif_2"]);
$myArray = explode('-', $col2);
$heb1 = $myArray[0];
$col3 = stripslashes($data["lib_tarif_3"]);
$myArray2 = explode('-', $col3);
$heb2 = $myArray2[0];
?>
					...
					<div data-spy="scroll" data-target="#myScrollspy" data-offset="0"  class="form-group">
							...
							<div class="col-sm-9"><select name="hebergement" class="select" onchange="document.form.submit()"><option value="">- - -</option><option value="famille" <?=((isset($_POST["hebergement"]) && $_POST["hebergement"] == "famille") ? " selected" : "")?>><?=$heb1?></option><option value="residence" <?=((isset($_POST["hebergement"]) && $_POST["hebergement"] == "residence") ? " selected" : "")?>> <?=$heb2?></option></select>
							</div>
						</div>
				 ...
				 <?
					...
					?>
					 ...
					 <div  align="left" class="form-group">
							<label  class="col-sm-5 control-label">Assurance Médicale/Rapatriement(1)</label>
					 ...
					 <div class="form-group">
							...
							<div class="col-sm-4"><input type="checkbox" name="ass_annulation" value="1" <?=((isset($_POST["ass_annulation"]) && $_POST["ass_annulation"] == "1") ? " checked" : "")?> onclick="document.form.ass_interruption.checked = false;document.form.ass_assistance.checked = false;document.form.submit()" /> &nbsp;&nbsp;<strong>3% du total</strong></div>
							<div class="col-sm-3" align="right">
							 <?
							 $soustotal = $total;
					 ...
					 <div class="form-group">
							<label  class="col-sm-5 control-label">Assurance Pack Multirisques (1+2) </label>
					...
					<div class="form-group">
							...
							<input hidden name="frais_adm" value="<?=$frais?>"  /></div>
					</div> 
