...
<html lang="fr">
    <head>    
        ...
        <title>Bec séjours linguistiques ados <?=($data2["nom"])?></title>  
        <meta name="keywords" content="Sejour linguistique junior,<?=stripslashes($data2["nom"])?>" />
        <meta name="description" content="Le BEC vous propose des séjours linguistiques <?=stripslashes($data2["nom"])?> pour adolescents.">
                ...
                <div class="container">
                    <div class="row"> 
                        ...
                        <div class="col-md-10"><br>
                             <h1>Séjours linguistiques ados <?=($data2["nom"])?></h1>
                        </div> 
