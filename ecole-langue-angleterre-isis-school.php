...
<html lang="fr">
    <head>        
        <title>Bec séjours linguistiques adultes - Ecoles de Langues Angleterre ISIS SCHOOL</title>  
        <meta name="keywords" content="séjours lingustique,adultes,étudiants,école ISIS />
        <meta name="description" content="BEC Séjours linguistiques: tous nos séjours avec les ecoles de langues ISIS">
        <meta name="author" content="BEC Séjour linguistique">  
                ...
                <div class="container">
                    <div class="row"> 
                        ...
                        <div class="col-md-10"><br>
                            <h1> Ecoles de Langues Angleterre ISIS SCHOOL</h1>
                        </div> 
