<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%" class="tableau">
	<tr class="titre2"><td>Pays</td><td align="right"><a href="admin.php?action=paysAjouter" style="color:#FFFFFF">Ajouter un pays</a></td></tr>
	<tr>
		<td colspan="2">
<br />
...
function sup(id) {
 if (confirm("Etes-vous sûr de vouloir supprimer ce pays ?")) {
  document.location.href='pays-sup.php?n='+id;
 }
}
</script>
...
while($row = mysql_fetch_array($exec))
{
	...
	<td class="cellule_basdroite"><a href="admin.php?action=paysModif&id=<?=$row[0]?>"><img src="../adminImg/crayon.gif" border="0" /></a></td>
