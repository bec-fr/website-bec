<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%" class="tableau">
	<tr class="titre2"><td>Suppléments</td><td align="right"><a href="admin.php?action=supplementAjouter&fiche=<?=$_GET["fiche"]?>&url_retour=<?=urlencode("admin.php?action=supplement&fiche=".$_GET["fiche"])?>" style="color:#FFFFFF">Ajouter un supplément</a></td></tr>
	<tr>
		<td colspan="2">
<br />
...
function sup(id, url_retour) {
 if (confirm("Etes-vous sûr de vouloir supprimer ce supplément ?")) {
...
<tr><td>Charger le fichier des suppléments</td></tr>
<tr><td>Le fichier doit être un au format csv (séparateur ";") et doit être formé comme les exemples suivants :<br /><a href="exemple_supplement_etudiant.csv" target="_blank">exemple 1</a> - <a href="exemple_supplement_etudiant2.csv" target="_blank">exemple 2</a></td></tr>
