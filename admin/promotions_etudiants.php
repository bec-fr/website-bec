<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%" class="tableau">
	<tr class="titre2"><td>Promotions étudiant</td><td align="right"><a href="admin.php?action=reductions_etudiants_Ajout" style="color:#FFFFFF">Ajouter une réduction</a></td></tr>
	<tr>
		<td colspan="2">
<br />
