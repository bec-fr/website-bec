...
if(isset($_POST['nom']) && $_POST['nom'] != ""){
	...
	if(isset($_GET['id'])){
		$requete = "UPDATE hebergement_minis SET nom='".addslashes($nom)."', description='".addslashes($description)."' WHERE id = '".addslashes($_GET['id'])."'";
		mysql_query($requete) or die(mysql_error());
		$id = $_GET['id'];
	}else{
		$requete = "INSERT INTO hebergement_minis (nom, description) VALUES ('".addslashes($nom)."', '".addslashes($description)."')";
		mysql_query($requete) or die(mysql_error());
		$id = mysql_insert_id();
	}
	...
	if(isset($_GET['id'])){
		$requete = "SELECT * FROM hebergement_minis WHERE id = '".addslashes($_GET['id'])."'";
