<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%" class="tableau">
	<tr class="titre2"><td>Formules</td><td align="right"><a href="admin.php?action=immersion_totale_formuleAjouter" style="color:#FFFFFF">Ajouter une formule</a></td></tr>
	<tr>
		<td colspan="2">
<br />
...
function sup(id) {
 if (confirm("Etes-vous sûr de vouloir supprimer cette formule ?")) {
  document.location.href='immersion_totale_formule-sup.php?n='+id;
 }
}
</script>
...
while($row = mysql_fetch_array($exec))
{
	...
	<td class="cellule_basdroite"><a href="admin.php?action=immersion_totale_formuleModif&id=<?=$row[0]?>"><img src="../adminImg/crayon.gif" border="0" /></a></td>
