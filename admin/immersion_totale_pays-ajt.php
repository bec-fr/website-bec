...
if(isset($_POST['nom']) && $_POST['nom'] != ""){
	...
	if(isset($_GET['id'])){
		$requete = "UPDATE immersion_totale_pays SET nom='".addslashes($nom)."' WHERE id = '".addslashes($_GET['id'])."'";
		mysql_query($requete) or die(mysql_error());
		$id = $_GET['id'];
	}else{
		$requete = "INSERT INTO immersion_totale_pays (nom) VALUES ('".addslashes($nom)."')";
		mysql_query($requete) or die(mysql_error());
		$id = mysql_insert_id();
	}
	...
	if(isset($_GET['id'])){
		$requete = "SELECT * FROM immersion_totale_pays WHERE id = '".addslashes($_GET['id'])."'";
