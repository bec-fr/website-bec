<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%" class="tableau">
	<tr class="titre2"><td>Catégorie</td><td align="right"><a href="admin.php?action=immersion_totale_catAjouter" style="color:#FFFFFF">Ajouter une catégorie</a></td></tr>
	<tr>
		<td colspan="2">
<br />
...
function sup(id) {
 if (confirm("Etes-vous sûr de vouloir supprimer cette catégorie ?")) {
  document.location.href='immersion_totale_cat-sup.php?n='+id;
 }
}
</script>
...
while($row = mysql_fetch_array($exec))
{
	...
	<td class="cellule_basdroite"><a href="admin.php?action=immersion_totale_catModif&id=<?=$row[0]?>"><img src="../adminImg/crayon.gif" border="0" /></a></td>
