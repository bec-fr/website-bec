                ...
                <div class="container">
                    <div class="row">
                         <div class="col-md-4 col-lg-4">
                            <span class="titre_scolaires">BEC Séjours Linguistiques</span>
                        </div>
         <!-- Menu-->
            ...
            <header> 
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5">                        
							...
							$query_r = "SELECT * FROM formule_junior WHERE 1";
							if(isset($_GET["pays"]) && $_GET["pays"] != ""){
                ...
                <div class="camera_wrap camera_white_skin" id="slide">
                             ...
                             <div class="container"> 
                                <div class="row">
                                    <div class="col-md-7 col-md-offset-5">
                                        <div class="titre animated fadeInRight delay1">Voyages Scolaires
                    ...
                    <!-- Item Slide --> 
                    <div data-src="imagesUp/bandeaux/78_c.jpg">
                        <div class="camera_caption fadeFromTop">
                             <div class="container"> 
                                <div class="row">
                                    <div class="col-md-7 col-md-offset-5">
                                        <div class="titre animated fadeInRight delay1">Séjours juniors
                                         
                                        </div>   
                                        <p class="animated fadeInRight delay2">Partez à San Diego du 12 au 26 juillet</p> 
                                       
                                        <div class="more animated fadeInRight delay4">
                                         <a class="button" href="http://www.becfrance.com/sejour-linguistique-adolescent-san-diego---san-diego---sejour-en-campus-ou-en-familles-hotesses-14-17-ans,64.html">Plus d'infos</a>
                    ...
                    <div data-src="img/slide/slides/3.jpg">
                        <div class="camera_caption fadeFromTop">
                             <div class="container"> 
                                <div class="row">
                                    <div class="col-md-7 col-md-offset-5">
                                        <div class="titre animated fadeInRight delay1">Etudiants adultes
            ...
            <section class="content_info">	
                <div class="container">
                    ...
                    <!-- End Newsletter Box -->
                        ...
                        <!-- Properties -->
                         <div class="col-md-12">   
                            <h1>BEC séjours linguistiques - Le monde est notre salle de classe </h1>	
