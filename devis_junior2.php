...
<html lang="fr">    <head>    
            <title>Bec séjours linguistiques Juniors - Poser une option</title> 
			 
			<meta name="description" content="BEC Séjour linguistiques - poser une option sur un séjour 12-17 ans">  
...
<script language='JavaScript' src='calendrier/dynCalendar.js'></script>
 <!-- Section Title -->            <div class="section_title juniors">                <div class="container">                    <div class="row"> 						                        <div class="col-md-10"><br>                            <h1> Séjour Juniors - Poser une option</h1>                        </div> 						<div class="col-md-2"></div>						                    </div>                </div>                        </div>            <!-- End Section Title -->			            <!-- End content info -->            <section class="content_info">	                <div class="container">					<!-- Newsletter Box -->                                      <div class="newsletter_box">                        <div class="container">                            <div class="row">                              <div class="col-md-9 titre"> 										<span><?=($fil_ariane)?></span>				                                </div>								                            </div>                        </div>                    </div>                    <!-- End Newsletter Box -->                                        <section class="row padding_top">                        <!-- Properties -->                        <div class="col-md-9">                            <!-- Contenu-->
...
<script type="text/javascript"> if (!window.mstag) mstag = {loadTag : function(){},time : (new Date()).getTime()};</script> <script id="mstag_tops" type="text/javascript" src="//flex.msn.com/mstag/site/06439453-89a6-4c59-8b71-7f259756792f/mstag.js"></script> <script type="text/javascript"> mstag.loadTag("analytics", {dedup:"1",domainId:"2863895",type:"1",actionid:"227086"})</script> <noscript> <iframe src="//flex.msn.com/mstag/tag/06439453-89a6-4c59-8b71-7f259756792f/analytics.html?dedup=1&domainId=2863895&type=1&actionid=227086" frameborder="0" scrolling="no" width="1" height="1" style="visibility:hidden;display:none"> </iframe> </noscript>
	...
	echo "<br><br><div align='justify' class='texteBleu'><b>Merci pour votre devis.<br>Un conseiller va vous contacter afin de finaliser votre inscription.</b><br>Remarque : votre prise d'option nous informe que vous êtes interessés par ce séjour mais ne garantit pas une place disponible. Seule une inscription confirme et réserve directement votre place.</div><br><br>";
}else{
                ...
                <table width="100%" border="0" align="center" cellpadding="3" class="texteGris">
                  <form action="" method="post" name="mail">
                    <input type="hidden" value="1" name="ok" />
                     <div class="titles">                                <span>ETAPE 2/2 : Pré-inscription</span>                                <br>                                <h1><i class="fa fa-edit"></i>&nbsp;Poser une option pour un séjour junior</h1>                               					</div> 
                    ...
                    <tr>
															   ...
															   <input  align="right" type="submit"  onclick="javascript:verifForm(); _gaq.push(['_trackPageview', '/options-jeunes.php']); return false;" class="button" value="OK">
