...
<html lang="fr">
    <head>   
        ...
        <meta name="description" content="Séjours linguistiques <?=stripslashes($data2["nom"])?> pour étudiants et adultes. Cours de langues, stages, jobs et préparations aux examens de langues">
