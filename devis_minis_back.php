...
if(isset($_POST["ok"]) && $_POST["ok"] == 1){
	...
	$query = "INSERT INTO devis_minis (destination, nb_adulte, nb_eleve, nb_eleve2,nb_eleve3,nb_pc, age, date_debut, date_fin,depart_nuit,retour_nuit, mode_voyage, mode_voyage2, trav,assurance,ass_complement,classe_etab, date_ca, datetime) VALUES ('".addslashes($_POST["destination"])."', '".addslashes($_POST["nb_adulte"])."', '".addslashes($_POST["nb_eleve"])."', '".addslashes($_POST["nb_eleve2"])."','".addslashes($_POST["nb_eleve3"])."', '".addslashes($_POST["nb_pc"])."', '".addslashes($_POST["age"])."', '".addslashes($_POST["date_debut"])."', '".addslashes($_POST["date_fin"])."','".addslashes($_POST["depart_nuit"])."', '".addslashes($_POST["retour_nuit"])."', '".addslashes($_POST["mode_voyage"])."', '".addslashes($_POST["mode_voyage2"])."', '".addslashes($_POST["trav"])."',  '".addslashes($_POST["assurance"])."','".addslashes($_POST["ass_complement"])."','".addslashes($_POST["classe_etab"])."', '".addslashes($_POST["date_ca"])."', '".date("Y-m-d H:i:s")."')";
...
<br />
                  ...
                  <form action="" class="form-horizontal" enctype="multipart/form-data" method="post" name="form">
					...
					<div class="form-group">
							...
							-16 ans <input name="nb_eleve" type="text" value="" size="2" class="inputtext" size="10" />
								16 /18 ans<input name="nb_eleve2" type="text" size="2"  value="" class="inputtext" size="10" />
								+ 18 ans <input name="nb_eleve3" type="text" size="2"  value="" class="inputtext" size="10" />
						</div>	
					</div>	
					<div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <option value="2PC">2PC</option><option value="3PC">3PC</option><option value="4PC">4PC</option><option value="5PC">5PC</option><option value="+ de 5PC">+ de 5PC</option>
        ...
        <script>
            ...
            datepickr('.datepickr', { dateFormat: 'y-m-d'});         
						...
						<div class="col-sm-5"><INPUT TYPE="checkbox" name="depart_nuit" value="1">	incluant un départ de nuit à l'aller
						</div>
					</div>
        ...
        <script>
            ...
            datepickr('.datepickr', { dateFormat: 'y-m-d'});         
						...
						<div class="col-sm-5">	 <INPUT TYPE="checkbox" name="retour_nuit" value="1"> incluant un départ de nuit au retour
						</div>
					</div>
