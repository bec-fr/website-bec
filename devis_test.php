...
<br />
                  ...
                  <form class="form-horizontal" action="" method="post" name="form">
					...
					<?if(isset($_POST["destination"]) && $_POST["destination"] != "" && $_POST["formule"] != "" && $_POST["hebergement"] != ""){?>
						...
						<h3>2- Indiquez une date de départ et le nombre de semaines de votre séjour</b><br><br></h3>
						<div class="form-group">
				 ...
				 <?
				   ...
				   <div><i><font size="-1">Sous réserve de modifications du programme des cours, du prix et de la disponibilité - base tarifaire 2015. Les devises étrangères, selon les CCG (Conditions commerciales générales), seront converties en euros au cours du jour de la date de l'inscription et peuvent varier, selon les fluctuations du marché des devises, par rapport au cours de change utilisé dans le devis. Le taux de change appliqué est donc celui de la date d'inscription et BEC Séjours Linguistiques vous garantit un prix fixe qui ne sera pas révisé en cas d'augmentation du taux de change. Les devis qui sont manifestement en présence d'une erreur de calcul ne peuvent être valables (base des prix: Prix originaux de l'école).</font></i></div>
				   <div align="right"><input  align="right" type="submit"  onclick="javascript:verifForm();" class="button" value="Passez à l'étape 2 (coordonnées)"></div>	
