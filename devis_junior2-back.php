...
<script language='JavaScript' src='calendrier/dynCalendar.js'></script>
 <!-- Section Title -->            <div class="section_title juniors">                <div class="container">                    <div class="row"> 						                        <div class="col-md-10"><br>                            <h1> Séjour Juniors</a>  / Etablir un devis</h1>                        </div> 						<div class="col-md-2"></div>						                    </div>                </div>                        </div>            <!-- End Section Title -->			            <!-- End content info -->            <section class="content_info">	                <div class="container">					<!-- Newsletter Box -->                                      <div class="newsletter_box">                        <div class="container">                            <div class="row">                              <div class="col-md-9 titre"> 										<span><?=($fil_ariane)?></span>				                                </div>								                            </div>                        </div>                    </div>                    <!-- End Newsletter Box -->                                        <section class="row padding_top">                        <!-- Properties -->                        <div class="col-md-9">                            <!-- Contenu-->
...
if(isset($_POST["ok"]) && $_POST["ok"] == 1){
	...
	envoi_mail($mail_site, "Devis depuis votre site Internet ".$url_site2, "Demande de devis depuis votre site Internet ".$url_site2."<br><br>Cliquez <a href='".$url_site."/admin'>ici</a> pour vous rendre dans l'administration afin d'obtenir le détail du devis junior.");
	...
	?>
    <!-- Google Code for Demande de devis junior Conversion Page -->
...
var google_conversion_label = "RdQfCIim3QEQuMnG-wM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/1064412344/?label=RdQfCIim3QEQuMnG-wM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
...
<script type="text/javascript"> if (!window.mstag) mstag = {loadTag : function(){},time : (new Date()).getTime()};</script> <script id="mstag_tops" type="text/javascript" src="//flex.msn.com/mstag/site/06439453-89a6-4c59-8b71-7f259756792f/mstag.js"></script> <script type="text/javascript"> mstag.loadTag("analytics", {dedup:"1",domainId:"2863895",type:"1",actionid:"227086"})</script> <noscript> <iframe src="//flex.msn.com/mstag/tag/06439453-89a6-4c59-8b71-7f259756792f/analytics.html?dedup=1&domainId=2863895&type=1&actionid=227086" frameborder="0" scrolling="no" width="1" height="1" style="visibility:hidden;display:none"> </iframe> </noscript>
	...
	echo "<br><br><div align='center' class='texteBleu'><b>Merci pour votre réservation.<br>Un conseiller va vous contacter afin de finaliser votre inscription.</b></div><br><br>";
}else{
                ...
                <table width="100%" border="0" align="center" cellpadding="3" class="texteGris">
                  <form action="" method="post" name="mail">
                    <input type="hidden" value="1" name="ok" />
                     <div class="titles">                                <span>ETAPE 2/2 : Pré-inscription</span>                                <br>                                <h1><i class="fa fa-edit"></i>&nbsp;Etablir un devis pour un séjour junior</h1>                               					</div> 
                    ...
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                     					  					   <td colspan="2" align="center" valign="bottom"><a href="javascript:verifForm();"><img src="images/btOk<?=$fic_nom?>.jpg" border="0" /></a></td>					  										  </td>
                    </tr>
                  </form>
                </table>
                <? } ?>
