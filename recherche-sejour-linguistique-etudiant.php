...
if(isset($_POST["pays"]) && $_POST["pays"] != ""){
	...
	$query2 = "SELECT pays FROM ville WHERE id = '".addslashes($_POST["ville"])."'";
...
if(isset($_POST["pays"]) && $_POST["pays"] != ""){
	$query2 = "SELECT * FROM pays WHERE id = '".addslashes($_POST["pays"])."'";
	$exec2 = mysql_query($query2) or die(mysql_error());
...
if(isset($_POST["ville"]) && $_POST["ville"] != ""){
	$query2 = "SELECT v.*, p.id as idpays, p.nom as pays FROM ville v INNER JOIN pays p ON v.pays = p.id WHERE v.id = '".addslashes($_POST["ville"])."'";
	$exec2 = mysql_query($query2) or die(mysql_error());
	$data2 = mysql_fetch_assoc($exec2);
...
if(isset($_POST["examen"]) && $_POST["examen"] != ""){
	$query2 = "SELECT * FROM examen exa  WHERE exa.id = '".addslashes($_POST["examen"])."'";
	$exec2 = mysql_query($query2) or die(mysql_error());
	$data2 = mysql_fetch_assoc($exec2);	
	$titre .= " Préparation examen ".stripslashes($data2["nom"])."";
}

if(isset($_POST["formule"]) && $_POST["formule"] != ""){
	$query2 = "SELECT * FROM formule formu WHERE formu.id = '".addslashes($_POST["formule"])."'";
	$exec2 = mysql_query($query2) or die(mysql_error());
	$data2 = mysql_fetch_assoc($exec2);	
...
<html lang="fr">
    <head>        
        <title>Bec séjours linguistiques adultes - <?=($titre)?></title> 
     
        <meta name="description" content="Trouver votre séjour linguistique étudiant à l'étranger">
                    ...
                    <!-- End Newsletter Box -->
                        ...
                        <div class="col-md-9">
							...
							<?					
									...
									if(isset($_POST["pays"]) && $_POST["pays"] != ""){
										$query .= " AND fea.pays = '".($_POST["pays"])."'";
									}
									if(isset($_POST["ville"]) && $_POST["ville"] != ""){
										$query .= " AND fea.ville = '".($_POST["ville"])."'";
									}
									if(isset($_POST["formule"]) && $_POST["formule"] != ""){
							...
							$data4 = mysql_fetch_assoc($exec4);
								 ...
								 ?>	
								<span>Cours + hébergement - à partir de
