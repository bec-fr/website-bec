...
<div class="junior_col_gauche_contenu texteGris">
	<a href="#" onclick="return false;" onmouseover="aff('info_tarif');" onmouseout="cache('info_tarif');" class="lienGris2">Le prix comprend</a><div id="info_tarif" align="justify" style="position:absolute; padding:10px; background-color:#FAFAFA; width:400px; margin-left:10px; margin-top:0px; border:#ed7902 2px solid; display:none;" onmouseout="cache('info_tarif');"><?=nl2br(stripslashes($data_d["prix_tout_compris"]))?></div><br />
    <a href="#" onclick="return false;" onmouseover="aff('info_tarif2');" onmouseout="cache('info_tarif2');" class="lienGris2">Le prix ne comprend pas</a><div id="info_tarif2" align="justify" style="position:absolute; padding:10px; background-color:#FAFAFA; width:400px; margin-left:10px; margin-top:0px; border:#ed7902 2px solid; display:none;" onmouseout="cache('info_tarif2');"><?=nl2br(stripslashes($data_d["prix_non_compris"]))?></div>
</div>
...
$i=1;
while($data2 = mysql_fetch_row($exec2)){
    $tab[] = "<a href='#' onclick='return false;' onmouseover='aff(\"formule_".$i."\");' onmouseout='cache(\"formule_".$i."\");' class='lienGris2'>".stripslashes($data2[0])."</a><div id='formule_".$i."' align='justify' style='position:absolute; padding:10px; background-color:#FAFAFA; width:400px; margin-left:10px; margin-top:0px; border:#ed7902 2px solid; display:none;' onmouseout='cache(\"formule_".$i."\");'>".nl2br(stripslashes($data2[1]))."</div>";
    $i++;
}
?>
<?=implode(", ", $tab)?></div>
...
$i=1;
while($data2 = mysql_fetch_row($exec2)){
    $tab[] = "<a href='#' onclick='return false;' onmouseover='aff(\"hebergement_".$i."\");' onmouseout='cache(\"hebergement_".$i."\");' class='lienGris2'>".stripslashes($data2[0])."</a><div id='hebergement_".$i."' align='justify' style='position:absolute; padding:10px; background-color:#FAFAFA; width:400px; margin-left:10px; margin-top:0px; border:#ed7902 2px solid; display:none;' onmouseout='cache(\"hebergement_".$i."\");'>".nl2br(stripslashes($data2[1]))."</div>";
    $i++;
}
?>
<?=implode(", ", $tab)?></div>
