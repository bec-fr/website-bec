...
<? include("connect.php"); ?>
<?
$query_d = "SELECT * FROM minis_pays WHERE id = '".addslashes($_GET["pays"])."'";
...
$fil_ariane .= " / <a href='voyages-scolaires-circuits-linguistiques-".url_rewrite(trim(strtolower(stripslashes($data_d["nom"])))).",".$data_d["id"].".html' class='texteBleu'>Voyage scolaire ".stripslashes($data_d["nom"])."</a>";

$title="Voyages scolaires et circuits linguistiques ".stripslashes($data_d["nom"]);
?>
...
<html lang="fr">
    <head>        
        <title>Voyages scolaires et circuits linguistiques <?=($data2["nom"])?> avec Bec séjours linguistiques</title>  
        <meta name="keywords" content="voyages scolaires linguistiques,<?=($data2["nom"])?>" />
                ...
                <div class="container">
                    <div class="row"> 
                        ...
                        <div class="col-md-10"><br>
                            <h1> Notre offre voyages scolaires - <?=($data2["nom"])?></h1>
                        </div> 
