...
function change_action(value){
	...
	document.rech.action = page;
                                    ...
                                    <div id="1-content" class="switcher-content set2 show">
                                       <div class="search_box">
                                            <form name="rech2" action="recherche_junior.php" method="get">
                                                ...
                                                <div>                                                   
                                                    <select name="pays" class="select" style="width:170px"  >
							...
							?>
                                                ...
                                                <div>
                                                    <br>                                     
                                                   <select name="ville" class="select" style="width:170px" onchange="document.rech.id_date.value=''; document.rech.formule.value=''; document.rech.hebergement.value='';" onchange="this.form.submit();">
							...
							?>
												...
												<div><br>                                                
                                                    <select name="formule" class="select" style="width:170px" onchange="document.rech.submit();">
							...
							<option selected value="5">Séjours Juniors 12-19 ans</option>
