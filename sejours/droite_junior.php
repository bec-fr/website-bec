...
<table width="195" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><? include("include/newsletter_junior.php"); ?>
...
<table border="0" cellpadding="0" cellspacing="0">
                    <form name="rech" action="http://www.becfrance.com/recherche_junior.php" method="get">
                    <tr>
                      <td><img src="http://www.becfrance.com/images/degradeMenuDroite.jpg" /></td>
                    </tr>
                    <tr>
                      <td style="padding-left:10px; padding-bottom:10px; padding-top:10px;"><img src="http://www.becfrance.com/images/titreRecherche_junior.jpg" /></td>
                    </tr>
                    <tr>
                      <td><img src="http://www.becfrance.com/images/degradeMenuDroite.jpg" /></td>
                    </tr>
                    ...
                    <tr>
                      <td><table align="center">
                          <tr>
                            ...
                            <option value="junior" <?=(($nom_fic == "recherche_junior.php" || $nom_fic == "fiche_junior.php" || $nom_fic == "junior_reserver_sejour.php" || $nom_fic == "junior_reserver_sejour2.php" || $nom_fic == "fiche_junior_test.php" || $nom_fic == "junior_reserver_sejour_test.php" || $nom_fic == "junior_reserver_sejour2_test.php" || $nom_fic == "index_junior.php") ? " selected" : "")?>>Juniors 12-17ans</option>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  <td style="padding-top:5px;"><a href="http://www.becfrance.com/brochure.php"><img src="http://www.becfrance.com/images/btDemandeBrochure_junior2.jpg" width="188" height="34" border="0" /></a></td>
</tr>
<tr>
  <td height="20"></td>
</tr>
