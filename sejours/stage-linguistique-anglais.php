...
<link rel="canonical" href="http://www.becfrance.com/sejours/stage-linguistique-anglais.php" />
                      ...
                      <td style="background:url(../images/ombre_droite_c.png); background-position:right; background-repeat:repeat-y;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
							...
							<div class="bouton_bord_gauche"><img alt="stage linguistique anglais"  src="images/bouton_bord_gauche_rouge.png" /></div>
                            ...
                            <td width="480" valign="top" ><table cellpadding="0" cellspacing="0" width="480" style="margin-top:-25px;">
		                        <tr>
                                  <td style="padding-top:-50px;"><span style="font-size:10px; font-family:Arial,Helvetica,sans-serif;"><a href="http://www.becfrance.com" style="color:#666666; text-decoration:none; font-family:Arial,Helvetica,sans-serif;">Accueil</a> > <h1 class="h1visi">Stage linguistique anglais</h1></span></td>
                                </tr>
                                <tr>
                                  <td><h2 class="accroche">Effectuez un Stage Linguistique d'anglais dans le pays de votre choix avec le BEC
</h2></td>
                                </tr>
								<br /><br />
                                <tr>
...
Le BEC (British European Centre) propose &agrave; tous ceux souhaitant progresser, des <strong>Stages Linguistiques d'anglais</strong> dans le pays de leur choix : Canada, Etats-Unis, Angleterre, Ecosse, Irlande, Malte... <br /><br />
...
-	Les S&eacute;jours en Immersion Totale : en individuel, destin&eacute;s &agrave; toutes personne souhaitant acc&eacute;l&eacute;rer l'apprentissage de l'anglais<br/>
...
Chacune de ces formules vous permettra de suivre un <em>Stage Linguistique d'anglais</em> ou dans une autre langue, encadr&eacute; par des professeurs certifi&eacute;s et des animateurs dipl&ocirc;m&eacute;s. 
<br /><br />
Nos &eacute;coles partenaires pour vos cours de langues &agrave; l'&eacute;tranger sont situ&eacute;es dans des villes de grande ou moyenne taille, en Europe et sur des destinations plus lointaines. Toutes nos destinations pourront satisfaire les aspirations et int&eacute;r&ecirc;ts culturels de tout un chacun.
<br /><br />
Vous recherchez un <strong>Stage Linguistique d'anglais</strong>, des <a href="sejours-scolaires-educatifs-berlin.php">S&eacute;jours Scolaires Educatifs &agrave; Berlin</a>, un <a href="voyage-linguistique-usa-adolescent.php">Voyage Linguistique aux USA pour votre ado</a> ? Le BEC a la solution qu'il vous faut ! D&eacute;couvrez sur notre site Internet www.becfrance.com toutes nos offres et pays de destinations pour que votre d&eacute;sir d'apprendre et de voyager se r&eacute;alise !
...
<a href="organismes-de-sejours-linguistiques.php">organismes de s&eacute;jours linguistiques</a>.</div>
									</td>
                                </tr>
                              </table></td>
