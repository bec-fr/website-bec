...
<link rel="canonical" href="http://www.becfrance.com/sejours/immersion-sejour-linguistique-famille.php" />
                      ...
                      <td style="background:url(../images/ombre_droite_c.png); background-position:right; background-repeat:repeat-y;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
							...
							<div class="bouton_bord_gauche"><img alt="immersion sejour linguistique famille"  src="images/bouton_bord_gauche_rouge.png" /></div>
                            ...
                            <td width="480" valign="top" ><table cellpadding="0" cellspacing="0" width="480" style="margin-top:-25px;">
		                        <tr>
                                  <td style="padding-top:-50px;"><span style="font-size:10px; font-family:Arial,Helvetica,sans-serif;"><a href="http://www.becfrance.com" style="color:#666666; text-decoration:none; font-family:Arial,Helvetica,sans-serif;">Accueil</a> > <h1 class="h1visi">Immersion sejour linguistique famille</h1></span></td>
                                </tr>
                                <tr>
                                  <td><h2 class="accroche">Optez pour une immersion lors d'un s&eacute;jour linguistique dans une famille d'accueil avec le BEC 
</h2></td>
                                </tr>
								<br /><br />
                                <tr>
...
Vous souhaitez progresser en anglais ? Le BEC (British European Centre) propose de nombreuses formules de s&eacute;jours accessibles aux &eacute;tudiants et aux adultes. Acc&eacute;l&eacute;rez l'apprentissage de la langue en choisissant une <strong>immersion pour votre s&eacute;jour linguistique chez une famille</strong> anglophone. <br /><br />
Le BEC s&eacute;lectionne soigneusement les familles h&ocirc;tesses afin de vous offrir tout le confort n&eacute;cessaire. Choisir l'<em>immersion lors d'un s&eacute;jour linguistique en famille</em> vous permet de mettre en pratique la langue des habitants du pays, tout en d&eacute;couvrant leur culture, leur fa&ccedil;on de vivre et leurs habitudes culinaires. Tr&egrave;s souvent, l'<strong>immersion pour un s&eacute;jour linguistique en famille</strong> s'av&egrave;re &ecirc;tre une exp&eacute;rience tr&egrave;s enrichissante et il arrive parfois que les &eacute;tudiants gardent contact avec leur famille d'accueil m&ecirc;me apr&egrave;s le s&eacute;jour !
<br /><br />
Vous envisagez de faire un <a href="voyage-linguistique-angleterre.php">voyage linguistique en Angleterre</a>, un <a href="stage-linguistique-new-york.php">stage linguistique &agrave; New York</a>, &agrave; Sydney... ? Avec le BEC, organisme sp&eacute;cialis&eacute; dans l'organisation de voyage scolaire et professionnel, trouvez la destination id&eacute;ale pour progresser dans une langue &eacute;trang&egrave;re. 
<br /><br />
En plus de vous permettre d'&eacute;tudier l'anglais, notre organisme propose &eacute;galement diff&eacute;rents <a href="voyage-linguistique-europe.php">voyages linguistiques en Europe</a>, comme par exemple des <a href="voyages-scolaires-italie.php">voyages scolaires en Italie</a>, en Allemagne, en Espagne... Profitez d'une exp&eacute;rience &agrave; l'&eacute;tranger pour allier l'apprentissage d'une langue et une exp&eacute;rience humainement forte. 
...
<a href="sejours-linguistiques-pas-cher.php">s&eacute;jours linguistiques pas cher</a>.</div>
									</td>
                                </tr>
                              </table></td>
