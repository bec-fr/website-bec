...
<link rel="canonical" href="http://www.becfrance.com/sejours/stage-linguistique-pas-cher.php" />
                      ...
                      <td style="background:url(../images/ombre_droite_c.png); background-position:right; background-repeat:repeat-y;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
							...
							<div class="bouton_bord_gauche"><img alt="stage linguistique pas cher"  src="images/bouton_bord_gauche_rouge.png" /></div>
                            ...
                            <td width="480" valign="top" ><table cellpadding="0" cellspacing="0" width="480" style="margin-top:-25px;">
		                        <tr>
                                  <td style="padding-top:-50px;"><span style="font-size:10px; font-family:Arial,Helvetica,sans-serif;"><a href="http://www.becfrance.com" style="color:#666666; text-decoration:none; font-family:Arial,Helvetica,sans-serif;">Accueil</a> > <h1 class="h1visi">Stage linguistique pas cher</h1></span></td>
                                </tr>
                                <tr>
                                  <td><h2 class="accroche">Trouvez votre S&eacute;jour Linguistique pas cher avec le BEC !
</h2></td>
                                </tr>
								<br /><br />
                                <tr>
...
Trouvez un <strong>Stage Linguistique pas cher</strong> vers de nombreuses destinations (Italie, Malte, Nouvelle Z&eacute;lande, Allemagne, Irlande...) gr&acirc;ce &agrave; l'organisme de voyages linguistiques BEC (British European Centre). Vous avez entre 12 et 17 ans, &ecirc;tes &eacute;tudiants ou adultes ? D&eacute;couvrez sur notre site Internet toutes les formules que nous proposons pour un <em>Stage Linguistique pas cher</em>. <br /><br />
Choisissez pour votre adolescent un S&eacute;jour Linguistique Junior. Celui-ci sera h&eacute;berg&eacute; dans une famille d'accueil ou dans un campus, une solution id&eacute;ale pour qu'il perfectionne son anglais. En plus des cours de qualit&eacute; qu'il suivra dans nos centres, il vivra des activit&eacute;s sportives et culturelles. 
<br /><br />
Vous avez plus de 16 ans, &ecirc;tes &eacute;tudiants/adultes et souhaitez vivre une exp&eacute;rience professionnelle &agrave; l'&eacute;tranger ? Le BEC permet &agrave; toute personne d&eacute;sireuse d'apprendre une langue &eacute;trang&egrave;re d'effectuer un stage de plusieurs semaines dans de nombreux secteurs d'activit&eacute;s : tourisme, h&ocirc;tellerie, marketing, journalisme... Vous suivrez &eacute;galement des cours de langues personnalis&eacute;s pour &eacute;voluer rapidement et communiquer ais&eacute;ment avec votre entourage sur place. 
<br /><br />
En plus de proposer des <strong>Stages Linguistiques pas chers</strong>, le BEC propose des <a href="cours-de-langues-londres.php">cours de langues &agrave; Londres</a>, des Stages dans des entreprises &eacute;trang&egrave;res, des <a href="voyages-scolaires-educatifs-barcelone.php">Voyages Scolaires Educatifs &agrave; Barcelone</a> et de nombreux autres <a href="voyages-scolaires-en-europe.php">Voyages Scolaires en Europe</a>... Alors n'h&eacute;sitez plus et vivez une exp&eacute;rience enrichissante &agrave; l'&eacute;tranger en nous choisissant !
...
<a href="sejours-scolaires-educatifs-new-york.php">s&eacute;jours scolaires &eacute;ducatifs New York</a>.</div>
									</td>
                                </tr>
                              </table></td>
