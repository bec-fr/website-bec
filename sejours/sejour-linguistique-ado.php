...
<title>S&eacute;jour linguistique ado | voyages scolaires angleterre</title>
...
<meta name="description" content="Vous cherchez &agrave; faire un s&eacute;jour linguistique pour ado ? Bec France, les sp&eacute;cialistes des s&eacute;jours linguistiques." />
...
<link rel="canonical" href="http://www.becfrance.com/sejours/sejour-linguistique-ado.php" />
                      ...
                      <td style="background:url(../images/ombre_droite_c.png); background-position:right; background-repeat:repeat-y;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
							...
							<div class="bouton_bord_gauche"><img alt="s&eacute;jour linguistique ado"  src="images/bouton_bord_gauche_rouge.png" /></div>
                            ...
                            <td width="480" valign="top" ><table cellpadding="0" cellspacing="0" width="480" style="margin-top:-25px;">
		                        <tr>
                                  <td style="padding-top:-50px;"><span style="font-size:10px; font-family:Arial,Helvetica,sans-serif;"><a href="http://www.becfrance.com" style="color:#666666; text-decoration:none; font-family:Arial,Helvetica,sans-serif;">Accueil</a> > <h1 class="h1visi">S&eacute;jour linguistique ado</h1></span></td>
                                </tr>
                                <tr>
                                  <td><h2 class="accroche">D&eacute;couvrez le s&eacute;jour linguistique pour ado id&eacute;al avec le BEC
</h2></td>
                                </tr>
								<br /><br />
                                <tr>
...
Depuis plus de 40 ans, notre organisme a permis &agrave; des milliers de jeunes de toute la France de participer &agrave; l'un de nos <strong>s&eacute;jours linguistiques pour ado</strong>. En proposant des programmes d'&eacute;tude de qualit&eacute;, &eacute;prouv&eacute;s et affin&eacute;s au fil des ans, le BEC est aujourd'hui la r&eacute;f&eacute;rence en mati&egrave;re de s&eacute;jours linguistiques. 
<br /><br />
Choisir le <em>s&eacute;jour linguistique pour ado</em> du BEC, c'est aussi choisir la s&ucirc;ret&eacute;. Pour nous, la s&eacute;curit&eacute; des jeunes qui nous sont confi&eacute;s est au coeur m&ecirc;me de nos programmes. Quels que soient les activit&eacute;s, les cours suivis, les adolescents sont confi&eacute;s &agrave; des professeurs et des animateurs dipl&ocirc;m&eacute;s. La plus grande partie de nos s&eacute;jours sont produits par notre &eacute;quipe et nos directions locales pour permettre un meilleur contr&ocirc;le de l'organisation du voyage. 
<br /><br />
Nos &eacute;coles partenaires sont situ&eacute;es dans des villes de grande ou moyenne taille, en Europe, aux Etats-Unis et sur des destinations plus lointaines. Cet &eacute;ventail de destinations, de par sa diversit&eacute;, pourra satisfaire les aspirations et int&eacute;r&ecirc;ts culturels de tout un chacun.
<br /><br />
Vous recherchez un <strong>s&eacute;jour linguistique pour votre ado</strong>, des <a href="cours-de-langues-etranger.php">cours de langues &agrave; l'&eacute;tranger</a>, des <a href="sejours-scolaires-educatifs.php">s&eacute;jours scolaires &eacute;ducatifs</a>, un <a href="stage-linguistique-pas-cher.php">stage linguistique pas cher</a> ? Le BEC (British European Centre) est la solution qu'il vous faut ! D&eacute;couvrez sur notre site Internet toutes nos offres et pays de destination pour que votre d&eacute;sir d'apprendre et de voyager se r&eacute;alise !
...
<a href="sejours-scolaires-educatifs.php">s&eacute;jours scolaires &eacute;ducatifs</a>.</div>
									</td>
                                </tr>
                              </table></td>
