...
<link rel="canonical" href="http://www.becfrance.com/sejours/voyage-linguistique-angleterre.php" />
                      ...
                      <td style="background:url(../images/ombre_droite_c.png); background-position:right; background-repeat:repeat-y;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
							...
							<div class="bouton_bord_gauche"><img alt="voyage linguistique Angleterre"  src="images/bouton_bord_gauche_rouge.png" /></div>
                            ...
                            <td width="480" valign="top" ><table cellpadding="0" cellspacing="0" width="480" style="margin-top:-25px;">
		                        <tr>
                                  <td style="padding-top:-50px;"><span style="font-size:10px; font-family:Arial,Helvetica,sans-serif;"><a href="http://www.becfrance.com" style="color:#666666; text-decoration:none; font-family:Arial,Helvetica,sans-serif;">Accueil</a> > <h1 class="h1visi">Voyage linguistique Angleterre</h1></span></td>
                                </tr>
                                <tr>
                                  <td><h2 class="accroche">Vivez un Voyage Linguistique en Angleterre de qualit&eacute; avec le BEC !
</h2></td>
                                </tr>
								<br /><br />
                                <tr>
...
Vous avez choisi d'effectuer un <strong>Voyage Linguistique en Angleterre</strong> propos&eacute;s par le British European Centre ? Tous nos programmes sont con&ccedil;us pour r&eacute;pondre aux besoins des &eacute;tudiants de tous &acirc;ges et horizons confondus. Pour chacun des &eacute;tudiants nous donnons toutes les cl&eacute;s pour progresser dans une langue mais aussi selon l'offre choisie.
<br /><br />
En vivant un <em>Voyage Linguistique en Angleterre</em> par exemple, le BEC vous offrent des opportunit&eacute;s uniques. En plus d'am&eacute;liorer votre niveau, vous pourrez &eacute;galement vivre une exp&eacute;rience professionnelle dans le secteur d'activit&eacute; qui vous correspond le mieux. Effectuez par exemple un <a href="stage-linguistique-londres.php">Stage Linguistique &agrave; Londres</a>, vous acquerrez les m&eacute;thodes n&eacute;cessaires pour am&eacute;liorer votre niveau d'anglais actuel dans un environnement professionnel, accro&icirc;tre vos opportunit&eacute;s d'emploi sur un march&eacute; de plus en plus comp&eacute;titif et vous sensibiliser davantage au monde de l'entreprise et aux m&eacute;thodes de travail &agrave; l'&eacute;tranger.
<br /><br />
...
Pour votre <strong>Voyage Linguistique en Angleterre</strong>, vous serez encadr&eacute; par des professeurs certifi&eacute;s pour que votre s&eacute;jour se d&eacute;roule dans des conditions optimum. 
<br /><br />
Vous souhaitez d&eacute;couvrir les destinations propos&eacute;es par le BEC, les modalit&eacute;s pour souscrire &agrave; un <a href="voyage-linguistique-londres.php">Voyage Linguistique &agrave; Londres</a>, des <a href="voyages-scolaires-berlin.php">Voyages Scolaires &agrave; Berlin</a>, des S&eacute;jours Linguistiques pour adultes ou adolescents, les diff&eacute;rents tarifs ? Rendez-vous sur le site Internet www.becfrance.com ! Vous avez une demande particuli&egrave;re concernant une offre, besoin d'un renseignement ? Nous vous invitons &agrave; nous contacter en remplissant le formulaire de contact. 
