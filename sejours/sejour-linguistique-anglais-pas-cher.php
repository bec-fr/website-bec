...
<title>S&eacute;jour linguistique anglais pas cher - s&eacute;jours linguistiques professionnels</title>
...
<meta name="description"  content="Vous cherchez &agrave; faire un s&eacute;jour linguistique anglais pas cher ? Bec France, les sp&eacute;cialistes des s&eacute;jours linguistiques." />
...
<link rel="canonical" href="http://www.becfrance.com/sejours/sejour-linguistique-anglais-pas-cher.php" />
                      ...
                      <td style="background:url(../images/ombre_droite_c.png); background-position:right; background-repeat:repeat-y;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
							...
							<div class="bouton_bord_gauche"><img alt="s&eacute;jour linguistique anglais pas cher"  src="images/bouton_bord_gauche_rouge.png" /></div>
                            ...
                            <td width="480" valign="top" ><table cellpadding="0" cellspacing="0" width="480" style="margin-top:-25px;">
		                        <tr>
                                  <td style="padding-top:-50px;"><span style="font-size:10px; font-family:Arial,Helvetica,sans-serif;"><a href="http://www.becfrance.com" style="color:#666666; text-decoration:none; font-family:Arial,Helvetica,sans-serif;">Accueil</a> > <h1 class="h1visi">S&eacute;jour linguistique anglais pas cher</h1></span></td>
                                </tr>
                                <tr>
                                  <td><h2 class="accroche">Trouvez votre s&eacute;jour linguistique d'anglais pas cher avec le BEC !
</h2></td>
                                </tr>
								<br /><br />
                                <tr>
...
L'organisme de voyages linguistiques BEC (British European Centre) vous permet de trouver un <strong>s&eacute;jour linguistique d'anglais pas cher</strong> vers de nombreuses destinations comme le Royaume-Uni, l'Australie, le Canada, les Etats-Unis et l'Afrique du Sud... Vous avez entre 12 et 17 ans, vous &ecirc;tes &eacute;tudiants, adultes ? D&eacute;couvrez toutes nos formules pour un <em>s&eacute;jour linguistique d'anglais pas cher</em> sur notre site Internet. <br /><br />
Vous avez entre 12 et 17 ans ? Optez par exemple pour un voyage linguistique aux USA pour adolescents ! Vous serez h&eacute;berg&eacute; dans une famille d'accueil, un moyen id&eacute;al pour perfectionner votre anglais. Vous assisterez &eacute;galement &agrave; des cours de qualit&eacute;s et &agrave; de nombreuses activit&eacute;s !
<br /><br />
Vous avez plus de 16 ans, &ecirc;tes &eacute;tudiants et souhaitez vivre une exp&eacute;rience professionnelle &agrave; l'&eacute;tranger ? Le BEC permet &agrave; toute personne d&eacute;sireuse d'apprendre une langue &eacute;trang&egrave;re d'effectuer un stage de plusieurs semaines dans de nombreux secteurs d'activit&eacute; : tourisme, h&ocirc;tellerie, marketing, journalisme... Vous suivrez &eacute;galement des cours de langues personnalis&eacute;s pour &eacute;voluer rapidement et communiquer ais&eacute;ment avec votre entourage sur place. 
<br /><br />
En plus de proposer des <strong>s&eacute;jours linguistiques d'anglais pas chers</strong>, le BEC pr&eacute;sente des <a href="cours-de-langues-londres.php">cours de langues &agrave; Londres</a>, des stages dans des entreprises &eacute;trang&egrave;res, des <a href="voyages-scolaires-educatifs-barcelone.php">voyages scolaires &eacute;ducatifs &agrave; Barcelone</a> et de nombreux autres <a href="voyages-scolaires-en-europe.php">voyages scolaires en Europe</a>... Alors n'h&eacute;sitez plus et vivez une exp&eacute;rience enrichissante &agrave; l'&eacute;tranger en nous choisissant !
